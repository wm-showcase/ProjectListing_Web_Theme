...
--------
To clone the ProjectListing_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/ProjectListing_Web_Theme.git
 cd ProjectListing_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from ProjectListing_Web_Theme directory
